...
#define FORMAT_1_OUTPUT "1"                   // FORMAT INPUT 1
#define FORMAT_2_OUTPUT "2 1 3"               // FORMAT INPUT 2
#define FORMAT_3_OUTPUT "1 2 3"               // FORMAT INPUT 2
#define FORMAT_4_OUTPUT "3 1 2"               // FORMAT INPUT 3
#define FORMAT_5_OUTPUT "1 0 2"               // FORMAT INPUT 4
#define FORMAT_6_OUTPUT "0 1 2"               // FORMAT INPUT 4
#define FORMAT_7_OUTPUT "2 3 1 0"             // FORMAT INPUT 5
#define FORMAT_8_OUTPUT "0 2 1 3"             // FORMAT INPUT 5  // TODO: exception ici, le premier parametre est '0'+'1'
#define FORMAT_9_OUTPUT "0 2 1 3"             // FORMAT INPUT 5
#define FORMAT_10_OUTPUT "1 2 0 0"            // FORMAT INPUT 6
#define FORMAT_11_OUTPUT "0 0 1 0"            // FORMAT INPUT 7
#define FORMAT_12_OUTPUT "1 0 0 0"            // FORMAT INPUT 8
#define FORMAT_13_OUTPUT "0 0 0 0"            // FORMAT INPUT 9
